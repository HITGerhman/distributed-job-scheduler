...
CREATE TABLE IF NOT EXISTS jobs (
  ...
  retry_backoff_seconds INT UNSIGNED NOT NULL DEFAULT 2,
  max_retry_backoff_seconds INT UNSIGNED NOT NULL DEFAULT 30,
  heartbeat_timeout_seconds INT UNSIGNED NOT NULL DEFAULT 15,
